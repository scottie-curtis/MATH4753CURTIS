...
#'
#' @param t0 a calculated value of t
#' @param xmax the maximum value of x to be plotted
#' @param n the sample size
#' @param alpha the value of alpha, e.g. 1-confidence level
#'
#' @return a plot with p-value areas, quantiles, and a p-value
#' @export
#'
#' @examples
#' \dontrun mypvalue(t0=2.3563,n=30,alpha=0.05)
